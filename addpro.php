          ...
          <div class="mt-1">
            <form >
              ...
              <div class="col-12">
                ...
                <input class="form-control" type="text" data-flatpickr data-alt-input="true" required>
              </div>
              <div class="col-12">
              ...
              <div class="col-6">
                ...
                <div class="dropdown">
                  <button class="btn  dropdown-toggle" type="button" data-toggle="dropdown">Customer Name</button>
              ...
              <div class="col-6">
                ...
                <div class="dropdown">
                  <button class="btn  dropdown-toggle" type="button" data-toggle="dropdown">Project Manager</button>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Action</a>
                    <a class="dropdown-item" href="#">Another action</a>
                    <a class="dropdown-item" href="#">Something else here</a>
